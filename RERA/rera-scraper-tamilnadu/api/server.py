"""FastAPI server for extension Place Report + RERA scrape (Tamil Nadu)."""
...
app = FastAPI(title="Tamil Nadu RERA Report API", version="1.0.0")
...
async def api_place_report(
    ...
    try:
        ...
        return {
            ...
            "message": (
                "Report placed. Tamil Nadu RERA scraping runs in the background — "
