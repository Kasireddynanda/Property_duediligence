"""FastAPI server for MP RERA Place Report + RERA scrape."""
...
app = FastAPI(title="Madhya Pradesh RERA Report API", version="1.0.0")
...
async def api_place_report(
    ...
    try:
        ...
        return {
            ...
            "message": "Report placed. MP RERA scraping runs in the background.",
        }
